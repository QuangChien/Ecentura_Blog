...
namespace Ecentura\Blog\Block\Html\Category;
...
class Pager extends \Magento\Framework\View\Element\Template
{
    ...
    protected $_template = 'Ecentura_Blog::html/pager.phtml';
    ...
    public function getCategoryName()
    {
        ...
        $categoryName = $category->getData()['url_key'];
     ...
     * @return string
     */
    public function getPreviousPageUrl($categoryName)
    {
        return $this->getPageUrl($this->getCollection()->getCurPage(-1), $categoryName);
    }
     ...
     * @return string
     */
    public function getNextPageUrl($categoryName)
    {
        return $this->getPageUrl($this->getCollection()->getCurPage(+1), $categoryName);
    }
     ...
     * @return string
     */
    public function getPageUrl($page, $categoryName)
    {
     ...
     * @return string
     */
    public function getLimitUrl($limit, $categoryName)
    {
        return $this->getPagerUrl($this->getPageLimitParams($limit), $categoryName);
    }
     ...
     * @return string
     */
    public function getPagerUrl($params = [], $categoryName = '')
    {
        $urlParams = [];
        $urlParams['_query'] = $params;
        $url = $this->getUrl('blog/category/' .$categoryName .'.html', $urlParams);
